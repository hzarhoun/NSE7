...
// Enter here the public IP of your computer with /32 mask
variable "mypublicip" {
  default = "<x.x.x.x/32>"
}

// Availability zones and Subnets CIDR
variable "az1" {
  default = "us-east-1a"
}
...
variable "spokeavpccidr" {
  default = "192.168.50.0/24"
}

variable "spokebvpccidr" {
...
variable "publicvpcacidr" {
  default = "192.168.50.0/28"
}

variable "tgwlandingvpca" {
  default = "192.168.50.16/28"
}

variable "publicvpcbcidr" {
  default = "192.168.100.0/28"
}

variable "tgwlandingvpcb" {
  default = "192.168.100.16/28"
}

variable "secvpcpublic1" {
  default = "10.0.0.0/28"
}

variable "secvpcprivate1" {
  default = "10.0.0.16/28"
}

variable "sectgwlanding1" {
  default = "10.0.0.32/28"
}

variable "secvpcpublic2" {
  default = "10.0.0.48/28"
}

variable "secvpcprivate2" {
  default = "10.0.0.64/28"
}

variable "sectgwlanding2" {
...
variable "bootstrap-fgt1" {
  // Change to your own path
  type    = string
  default = "fortigate1.conf"
}

variable "bootstrap-fgt2" {
  // Change to your own path
  type    = string
  default = "fortigate2.conf"
}
